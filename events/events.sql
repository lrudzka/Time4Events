...
--
-- Host: localhost
-- Generation Time: Sep 14, 2018 at 11:23 AM
...
INSERT INTO `eventCategory` (`id`, `category`) VALUES
(6, 'demonstracja'),
(5, 'gra miejska'),
(90, 'inne'),
(1, 'koncert'),
...
INSERT INTO `events` (`id`, `name`, `description`, `category`, `startDate`, `startTime`, `endDate`, `endTime`, `picture`, `www`, `province`, `city`, `address`, `createdBy`, `createdOn`) VALUES
